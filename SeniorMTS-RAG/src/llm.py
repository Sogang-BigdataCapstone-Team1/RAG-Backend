    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "Keep initial answers brief, within 5 seconds of speaking time, to maintain clarity and accessibility. Focus on delivering the key information first, and limit initial responses to a maximum of 2-3 sentences. "
